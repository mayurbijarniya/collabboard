          ...
          <div className="container mx-auto px-4 md:px-6 max-w-2xl">
            ...
            <div className="space-y-6 text-slate-600 text-sm leading-relaxed">
              <section>
                ...
                <p>
                  At CollabBoard, we take your privacy seriously. This Privacy Policy explains how
              ...
              <section>
                ...
                <p>
                  We collect information you provide when creating an account (name, email), usage
                  data (boards, notes, interactions), and technical data (IP address, browser type,
                  device information).
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  service providers who assist in operating our platform, law enforcement when
                  required by law, and in connection with a merger or acquisition.
                </p>
              </section>

              <section>
                <h2 className="text-base font-semibold text-slate-900 mb-2">5. Data Security</h2>
                <p>
                  We implement industry-standard security measures including encryption of data in
                  transit and at rest, regular security audits, and secure infrastructure practices.
              ...
              <section>
                ...
                <p>
                  CollabBoard is not intended for use by children under 13. We do not knowingly
                  collect personal information from children under 13.
                </p>
              </section>

              <section>
                <h2 className="text-base font-semibold text-slate-900 mb-2">9. Changes</h2>
                <p>
                  We may update this Privacy Policy from time to time. Continued use after changes
