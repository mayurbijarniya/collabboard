...
const ScribbleUnderlineThick = ({ className }: { className?: string }) => (
  ...
  >
    <path
      d="M2 12 Q35 2 70 10 Q105 18 138 6"
      stroke="currentColor"
      strokeWidth="3.5"
      strokeLinecap="round"
      fill="none"
...
const StarSVG = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path
      d="M256 24L316 188H492L348 292L396 488L256 380L116 488L164 292L20 188H196L256 24Z"
      stroke="currentColor"
      strokeWidth="32"
      strokeLinecap="round"
...
const CrownSVG = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 80" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path
      d="M10 68 L90 68 L82 22 L50 44 L18 22 Z"
      stroke="currentColor"
      strokeWidth="3.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const TealSquiggle = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 40 180" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path
      d="M20 0 Q38 28 20 56 Q2 84 20 112 Q38 140 20 168 Q12 176 4 180"
      stroke="currentColor"
      strokeWidth="2.5"
      fill="none"
      strokeLinecap="round"
      ...
      <div className="flex -space-x-2">
        {imgs.map((i) => (
          <img
            ...
            alt=""
            className={`${s} rounded-full border-2 border-white object-cover`}
          />
        ))}
      </div>
      {extra && (
        <div
          className={`ml-1.5 ${size === "sm" ? "text-[10px] px-1.5 py-0.5" : "text-xs px-2 py-1"} bg-teal-100 text-teal-700 font-bold rounded-full`}
        >
          {extra}
        </div>
      )}
...
function MockCard({
  ...
  return (
    <div
      className={`bg-white rounded-2xl shadow-lg border border-slate-100 ${borderColor} border-t-[3px] p-4 ${className}`}
    >
      {children}
    </div>
  );
    ...
    <div className="min-h-screen bg-white text-slate-900 overflow-x-hidden">
      <style
        dangerouslySetInnerHTML={{
          __html: `.font-hand { font-family: 'Caveat', cursive !important; }`,
        }}
      />
      <LandingNavbar />
      ...
      <main>
        ...
        >
          <div className="pointer-events-none absolute bottom-0 right-0 z-[2] w-[68%] h-[65%] hidden lg:block">
            ...
            >
              ...
              <g clipPath="url(#heroPaintBlob)" filter="url(#paintRoughness)">
                ...
                <path
                  d="M-20 355 Q160 315 340 282 Q520 250 680 220 L680 305 Q520 332 340 362 Q160 392 -20 425 Z"
                  fill="#2563EB"
                  opacity="0.9"
                />
                <path
                  d="M-20 390 Q170 355 350 325 Q530 295 680 270 L680 480 L-20 480 Z"
                  fill="#1D4ED8"
                  opacity="0.8"
                />
                {/* Horizontal brush streaks */}
                <path
                  d="M20 340 Q200 310 380 285 Q560 260 660 245"
                  stroke="#60A5FA"
                  strokeWidth="18"
                  strokeLinecap="round"
                  opacity="0.35"
                ...
                />
                <path
                  d="M0 365 Q180 335 360 310 Q540 285 640 270"
                  stroke="#93C5FD"
                  strokeWidth="12"
                  strokeLinecap="round"
                  opacity="0.25"
                ...
                />
                <path
                  d="M40 380 Q220 355 400 332 Q580 308 680 295"
                  stroke="#3B82F6"
                  strokeWidth="22"
                  strokeLinecap="round"
                  opacity="0.4"
                ...
                />
                <path
                  d="M10 400 Q190 375 370 352 Q550 328 650 315"
                  stroke="white"
                  strokeWidth="8"
                  strokeLinecap="round"
                  opacity="0.15"
                ...
                />
                <path
                  d="M60 420 Q240 398 420 375 Q600 352 680 340"
                  stroke="#60A5FA"
                  strokeWidth="14"
                  strokeLinecap="round"
                  opacity="0.3"
                ...
                />
                <path
                  d="M30 445 Q210 422 390 400 Q570 378 660 365"
                  stroke="#1E40AF"
                  strokeWidth="20"
                  strokeLinecap="round"
                  opacity="0.5"
                ...
                <path
                  d="M80 350 Q260 325 440 302 Q620 280 680 268"
                  stroke="white"
                  strokeWidth="6"
                  strokeLinecap="round"
                  opacity="0.2"
                ...
                />
                <path
                  d="M120 375 Q300 352 480 330 Q660 308 680 305"
                  stroke="white"
                  strokeWidth="4"
                  strokeLinecap="round"
                  opacity="0.12"
          ...
          <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6">
            ...
            <div className="hidden xl:block absolute top-6 right-[18%] z-20 select-none pointer-events-none text-right">
              <p className="font-hand text-xl font-bold text-slate-700 rotate-3 leading-tight">
            ...
            <StarSVG className="hidden lg:block absolute bottom-[15%] left-[48%] w-5 h-5 text-slate-700 opacity-40 z-20 pointer-events-none -rotate-6" />
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center pt-6 sm:pt-10 lg:min-h-[82vh]">
              <div className="relative z-20 max-w-2xl">
                <FadeIn>
                  <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] font-black tracking-tight leading-[1.04] mb-5 text-slate-900 ">
                    Ideas stick.
                    <br />
                ...
                <FadeIn delay={0.1}>
                  <p className="text-lg sm:text-xl text-slate-600 mb-8 leading-relaxed max-w-lg">
                    CollabBoard is your visual workspace for sticky notes, checklists, and real
                    teamwork. Plan, organize, and get things done, together.
                  </p>
                </FadeIn>
                <FadeIn delay={0.2} className="flex flex-wrap gap-3 sm:gap-4">
                  <Button
                    asChild
                    size="lg"
                    className="h-12 sm:h-14 px-6 sm:px-8 text-base sm:text-lg bg-blue-600 hover:bg-blue-700 text-white rounded-xl shadow-lg shadow-blue-600/20 hover:scale-105 transition-all"
                  >
                  ...
                  <Button
                    ...
                    size="lg"
                    asChild
                    className="h-12 sm:h-14 px-5 sm:px-7 text-base sm:text-lg rounded-xl border-slate-300 bg-white/80 backdrop-blur-sm"
                  >
                    <Link
                      href="https://collabboard.mayur.app/public/boards/demo"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Open Demo <ArrowUpRight className="ml-2 h-5 w-5" />
                    </Link>
                  </Button>
                </FadeIn>
                <FadeIn delay={0.3} className="mt-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 ">of creators and teams</p>
                    </div>
                  </div>
                </FadeIn>
                <FadeIn delay={0.4} className="mt-6 hidden lg:block">
                  <div className="flex items-start gap-2">
                    <p className="font-hand text-xl text-slate-700 rotate-[-2deg]">
                      Built for
                      <br />
                      modern teams
                    </p>
              ...
              <FadeIn delay={0.25} direction="none" className="relative hidden lg:block">
                ...
                <div className="absolute right-2 -bottom-8 z-40">
                  <div
                    className="w-[100px] h-[100px] bg-blue-600 rounded-[22px] shadow-2xl flex items-center justify-center text-white text-4xl font-black rotate-6 select-none"
                    style={{
                      boxShadow:
                        "0 12px 40px 0 rgba(30,64,175,0.5), inset 0 2px 0 rgba(255,255,255,0.2)",
                    }}
                  >
                ...
                <div className="absolute -right-16 top-[32%] z-50 rotate-6 select-none pointer-events-none">
                  <div className="relative bg-slate-900 text-white px-4 py-2.5 rounded-2xl shadow-xl font-hand text-lg font-bold flex items-center gap-2 whitespace-nowrap">
                    Let&apos;s do this! <Zap className="w-4 h-4 text-amber-400 fill-amber-400" />
                    <div className="absolute top-1/2 -left-2 w-4 h-4 bg-slate-900 rotate-45 -translate-y-1/2" />
                  </div>
                </div>
                ...
                {/* Browser window */}
                <div className="bg-white/90 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-2xl overflow-hidden -rotate-2 hover:rotate-0 transition-all duration-500 relative">
                  <div className="h-11 bg-slate-100/70 border-b border-slate-200 flex items-center px-3 gap-2">
                    <div className="flex gap-1.5 flex-shrink-0">
                      <div className="w-3 h-3 rounded-full bg-red-400" />
                      <div className="w-3 h-3 rounded-full bg-amber-400" />
                      <div className="w-3 h-3 rounded-full bg-green-400" />
                    </div>
                    <div className="flex items-center justify-center flex-1 mx-2 bg-white px-4 py-1 rounded-md text-xs text-slate-400 font-medium shadow-sm text-center gap-1">
                      Product Launch{" "}
                      <svg
                    ...
                    <div className="ml-1.5 px-2.5 py-1 bg-blue-600 text-white text-xs font-bold rounded-lg flex-shrink-0">
                      Share
                    </div>
                  </div>
                  <div className="p-5 flex h-[440px]">
                    <div className="w-10 border-r border-slate-100 flex flex-col items-center gap-5 py-3 mr-3 text-slate-300">
                    ...
                    <div className="flex-1 grid grid-cols-3 gap-3">
                      ...
                      <div className="flex flex-col gap-3">
                        <div className="bg-purple-100 p-4 rounded-2xl shadow-sm border border-purple-200/50 relative">
                          <div className="absolute -top-1.5 right-3 w-4 h-4 bg-purple-500 rounded-full" />
                          <h4 className="font-bold text-purple-900 mb-2.5 text-sm">Launch ideas</h4>
                          <div className="space-y-1.5">
                            {[
                              { c: true, t: "Target audience" },
                              { c: true, t: "Value proposition" },
                              { c: false, t: "Messaging" },
                            ].map((r, i) => [
                              <div
                                key={i}
                                className={`flex items-center gap-1.5 text-xs text-purple-800 ${!r.c ? "opacity-55" : ""}`}
                              >
                                {r.c ? (
                                  <CheckCircle className="w-3.5 h-3.5 text-purple-500 flex-shrink-0" />
                                ) : (
                                  <div className="w-3.5 h-3.5 border border-purple-400 rounded flex-shrink-0" />
                                )}
                                {r.t}
                              </div>,
                            ])}
                        ...
                        <div className="bg-pink-100 p-4 rounded-2xl shadow-sm border border-pink-200/50">
                          <h4 className="font-bold text-pink-900 mb-2.5 text-sm">Website update</h4>
                          <div className="space-y-1.5">
                            {[
                              { c: false, t: "Landing page" },
                              { c: true, t: "Features page" },
                              { c: false, t: "Blog post" },
                            ].map((r, i) => [
                              <div
                                key={i}
                                className={`flex items-center gap-1.5 text-xs text-pink-800 ${!r.c ? "opacity-55" : ""}`}
                              >
                                {r.c ? (
                                  <CheckCircle className="w-3.5 h-3.5 text-pink-500 flex-shrink-0" />
                                ) : (
                                  <div className="w-3.5 h-3.5 border border-pink-400 rounded flex-shrink-0" />
                                )}
                                {r.t}
                              </div>,
                            ])}
                      ...
                      <div className="flex flex-col gap-3 mt-4">
                        <div className="bg-yellow-100 p-4 rounded-2xl shadow-sm border border-yellow-200/50">
                          <h4 className="font-bold text-yellow-900 mb-2.5 text-sm">
                            Design roadmap
                          </h4>
                          <div className="space-y-1.5">
                            {[
                              { c: false, t: "Wireframes" },
                              { c: false, t: "Brand assets" },
                              { c: true, t: "User feedback" },
                            ].map((r, i) => [
                              <div
                                key={i}
                                className={`flex items-center gap-1.5 text-xs text-yellow-800 ${!r.c ? "opacity-55" : ""}`}
                              >
                                {r.c ? (
                                  <CheckCircle className="w-3.5 h-3.5 text-yellow-600 flex-shrink-0" />
                                ) : (
                                  <div className="w-3.5 h-3.5 border border-yellow-500 rounded flex-shrink-0" />
                                )}
                                {r.t}
                              </div>,
                            ])}
                        ...
                        <div className="bg-green-100 p-4 rounded-2xl shadow-sm border border-green-200/50">
                          <h4 className="font-bold text-green-900 mb-2.5 text-sm">
                            Release checklist
                          </h4>
                          <div className="space-y-1.5">
                            {[
                              { c: false, t: "QA testing" },
                              { c: false, t: "Bug fixes" },
                              { c: true, t: "Final review" },
                              { c: false, t: "Go live" },
                            ].map((r, i) => [
                              <div
                                key={i}
                                className={`flex items-center gap-1.5 text-xs text-green-800 ${!r.c ? "opacity-55" : ""}`}
                              >
                                {r.c ? (
                                  <CheckCircle className="w-3.5 h-3.5 text-green-600 flex-shrink-0" />
                                ) : (
                                  <div className="w-3.5 h-3.5 border border-green-500 rounded flex-shrink-0" />
                                )}
                      ...
                      {/* Col 3 */}
                      <div className="flex flex-col gap-3">
                        <div className="bg-blue-100 p-4 rounded-2xl shadow-sm border border-blue-200/50">
                          <h4 className="font-bold text-blue-900 mb-2.5 text-sm">Marketing plan</h4>
                          <div className="space-y-1.5">
                            {[
                              { c: true, t: "Social campaign" },
                              { c: false, t: "Email outreach" },
                              { c: false, t: "Partnerships" },
                            ].map((r, i) => [
                              <div
                                key={i}
                                className={`flex items-center gap-1.5 text-xs text-blue-800 ${!r.c ? "opacity-55" : ""}`}
                              >
                                {r.c ? (
                                  <CheckCircle className="w-3.5 h-3.5 text-blue-500 flex-shrink-0" />
                                ) : (
                                  <div className="w-3.5 h-3.5 border border-blue-400 rounded flex-shrink-0" />
                                )}
                                {r.t}
                              </div>,
                            ])}
                ...
                <div className="absolute -bottom-4 left-[15%] z-50 select-none">
                  <div className="bg-white p-3.5 rounded-2xl shadow-2xl border border-slate-100 rotate-1 flex items-center gap-3 w-60">
                    <div className="w-7 h-7 rounded-full bg-emerald-100 flex items-center justify-center flex-shrink-0">
                      <Check className="w-4 h-4 text-emerald-600" strokeWidth={3} />
                    </div>
                    <div>
                      <p className="font-bold text-xs text-slate-900 ">Team update</p>
                      <p className="text-[11px] text-slate-500 leading-snug">
                        We&apos;re on track for an amazing launch!
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute -right-2 bottom-[15%] z-50 pointer-events-none">
                  <SparkBurst className="w-8 h-8 text-slate-800 " />
                </div>
              </FadeIn>
            </div>
          </div>
        ...
        <section
          id="features"
          className="py-16 sm:py-20 lg:py-28 px-4 sm:px-6 bg-white relative overflow-hidden"
        >
          <div
          ...
          <div className="hidden lg:flex absolute top-10 right-[18%] flex-col items-center z-10 select-none pointer-events-none">
            <p className="font-hand text-lg font-semibold text-slate-700 -rotate-2 text-center">
          ...
          <StarSVG className="hidden lg:block absolute top-16 left-[44%] w-6 h-6 text-slate-800 opacity-40 stroke-2 z-10 pointer-events-none" />
          ...
          <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-10 lg:gap-20 items-center relative z-10">
            <div>
              <FadeIn>
                ...
                <h2 className="text-4xl sm:text-5xl md:text-[3.5rem] font-black leading-[1.08] mb-5 text-slate-900 ">
                  Work your way.
                  <br />
                  Visual. <span className="text-blue-600">Simple.</span>
                  <br />
              ...
              <FadeIn delay={0.1}>
                <p className="text-base sm:text-lg text-slate-600 mb-8 max-w-md">
                  From big ideas to daily tasks. Capture everything with sticky notes and checklists
                  that fit the way your team works.
                </p>
              </FadeIn>
              <FadeIn delay={0.2} className="space-y-6 max-w-md">
                {[
                  {
                    title: "Sticky notes for ideas & tasks",
                    desc: "Capture anything in a snap.",
                    color: "bg-teal-100 text-teal-600",
                    icon: FileText,
                  },
                  {
                    title: "Checklists for clear action",
                    desc: "Break it down. Get it done.",
                    color: "bg-blue-100 text-blue-600",
                    icon: CheckCircle,
                  },
                  {
                    title: "Boards for every project",
                    desc: "Organize, focus, ship faster.",
              ...
              <FadeIn delay={0.3} className="mt-8 inline-block">
                <div className="px-5 py-4 bg-amber-50 border border-amber-200 rounded-2xl rotate-2 relative shadow-md max-w-xs">
                  <Star className="absolute -top-3 -left-3 w-6 h-6 text-amber-500 fill-amber-400" />
                  <p className="text-amber-900 font-medium text-sm">
                    Built for teams that move fast and{" "}
                    <span className="font-bold text-blue-700 relative inline-block">
                      think big.
            ...
            <FadeIn delay={0.2} direction="right" className="relative hidden md:block">
              <div className="bg-white/60 backdrop-blur-2xl rounded-[2.5rem] border border-slate-200/50 shadow-2xl p-6">
                <div className="flex items-center justify-end gap-2 mb-6">
                  <div className="flex items-center gap-2 bg-white px-3 py-1.5 rounded-full shadow-sm border border-slate-100 ">
                    ...
                    <span className="text-xs font-bold text-teal-600 border border-teal-200 bg-teal-50 px-2.5 py-0.5 rounded-full">
                      + Invite
                    </span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-3 mb-3">
                  <MockCard borderColor="border-t-blue-400" className="-rotate-1 -mt-2">
                    <h4 className="font-bold text-slate-800 mb-3 text-sm">Research</h4>
                    <div className="space-y-2">
                      {[
                        { c: true, t: "Market analysis" },
                        { c: true, t: "User interviews" },
                        { c: false, t: "Competitor scan" },
                      ].map((r, i) => [
                        <div
                          key={i}
                          className={`flex items-center gap-2 text-sm text-slate-600 ${!r.c ? "opacity-55" : ""}`}
                        >
                          {r.c ? (
                    ...
                    <img
                      src="/avatar/avatar3.png"
                      className="w-7 h-7 rounded-full mt-4 border-2 border-white"
                      alt=""
                    />
                  </MockCard>
                  <MockCard borderColor="border-t-teal-400" className="rotate-1 mt-3">
                    <h4 className="font-bold text-slate-800 mb-3 text-sm">Design</h4>
                    <div className="space-y-2">
                      {[
                        { c: true, t: "Wireframes" },
                        { c: true, t: "UI exploration" },
                        { c: false, t: "Feedback" },
                      ].map((r, i) => [
                        <div
                          key={i}
                  ...
                  <MockCard borderColor="border-t-amber-400" className="-rotate-1 -mt-1">
                    <h4 className="font-bold text-slate-800 mb-3 text-sm">Launch</h4>
                    <div className="space-y-2">
                      {[
                        { c: true, t: "Beta testing" },
                        { c: true, t: "User feedback" },
                        { c: false, t: "Improve" },
                      ].map((r, i) => [
                        <div
                ...
                <div className="grid grid-cols-3 gap-3">
                  <MockCard borderColor="border-t-emerald-400" className="rotate-1 mt-2">
                    <h4 className="font-bold text-slate-800 mb-3 text-sm">Content Plan</h4>
                    <div className="space-y-2">
                      {[
                        { c: true, t: "Blog post" },
                        { c: false, t: "Social posts" },
                        { c: false, t: "Newsletter" },
                      ].map((r, i) => [
                        <div
                          key={i}
                          className={`flex items-center gap-2 text-sm text-slate-600 ${!r.c ? "opacity-55" : ""}`}
                  ...
                  <MockCard borderColor="border-t-teal-400" className="-rotate-1 mt-5">
                    <h4 className="font-bold text-slate-800 mb-3 text-sm">Product Roadmap</h4>
                    <div className="space-y-2">
                      {[
                        { c: true, t: "New integrations" },
                        { c: false, t: "Mobile app" },
                        { c: false, t: "AI assistant" },
                      ].map((r, i) => [
                        <div
                          key={i}
                          className={`flex items-center gap-2 text-sm text-slate-600 ${!r.c ? "opacity-55" : ""}`}
                  ...
                  <div className="bg-white p-4 rounded-3xl shadow-xl border border-slate-100 mt-2">
                    <h4 className="font-bold text-slate-900 mb-4 text-sm">Team Progress</h4>
                    ...
                    <div className="space-y-2.5 text-xs font-medium px-1">
                      {[
                        { c: "bg-teal-500", l: "Done", v: "76%" },
                        { c: "bg-blue-300", l: "In Progress", v: "18%" },
                        { c: "bg-slate-200", l: "To Do", v: "6%" },
                      ].map((r) => [
                ...
                <div className="mt-4 bg-white rounded-2xl shadow-lg border border-slate-200 px-5 py-2.5 flex items-center gap-5 w-fit mx-auto">
                ...
                <div className="mt-3 text-center select-none pointer-events-none">
                  ...
                  <p className="font-hand text-base text-slate-600 rotate-3">
            ...
            <div className="md:hidden grid grid-cols-2 gap-3 mt-4">
              {[
                ...
                <div
                  key={c.title}
                  className={`${c.bg} p-4 rounded-2xl shadow-sm border border-slate-100`}
                >
                  ...
                  <div className="space-y-1.5">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="flex items-center gap-1.5">
                        {i < 3 ? (
                          <CheckCircle className="w-3.5 h-3.5 text-current opacity-60 flex-shrink-0" />
                        ) : (
                          <div className="w-3.5 h-3.5 border border-current opacity-40 rounded flex-shrink-0" />
                        )}
        ...
        <section className="py-16 sm:py-20 lg:py-28 px-4 sm:px-6 bg-slate-50/70 relative overflow-hidden">
          <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="relative z-20">
              <FadeIn>
                <div className="inline-block relative mb-5">
                  <span className="relative z-10 px-4 py-1.5 font-semibold text-slate-800 text-sm">
                    Share without limits
                  </span>
                  <div className="absolute inset-0 bg-teal-50 rounded-full rotate-1 -z-10 border border-teal-200" />
              ...
              <FadeIn delay={0.1}>
                <p className="text-base sm:text-lg text-slate-600 mb-8 max-w-md">
                  Share boards with anyone. No sign-ups, no friction, just a clean, read-only view
              ...
              <FadeIn delay={0.2} className="space-y-6 max-w-md">
                {[
                  {
                    title: "Public read-only boards",
                    desc: "Share progress with clients, partners, or the world.",
                    color: "bg-blue-100 text-blue-600",
                    icon: Globe,
                  },
                  {
                  ...
                  <div key={i} className="flex gap-4">
                    <div
                      className={`w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0 ${item.color}`}
                    >
                      <item.icon className="w-5 h-5" />
                    </div>
                    <div>
              ...
              <FadeIn delay={0.3} className="mt-8">
                <div className="inline-flex items-center gap-3 px-5 py-3.5 bg-white border border-slate-200 rounded-2xl shadow-sm">
                  ...
                  <p className="text-sm text-slate-800 font-medium">
                    ...
                    <br />
                    <span className="text-slate-500 text-xs">You decide what&apos;s public.</span>
                  </p>
                </div>
              </FadeIn>
            </div>
            ...
            <FadeIn delay={0.2} direction="right" className="relative hidden md:block">
              <div className="absolute -top-6 right-14 z-20 select-none pointer-events-none text-right">
                <p className="font-hand text-lg font-semibold text-slate-700 -rotate-2 leading-tight">
                  <span className="relative inline-block">
                    One link.
                    <ScribbleUnderline className="absolute -bottom-1 left-0 w-full h-2 text-teal-500" />
                  </span>
                  <br />
                  Everyone aligned.
                </p>
              ...
              <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden mt-8">
                <div className="bg-slate-100 border-b border-slate-200 px-4 py-2.5 flex items-center gap-3">
                  ...
                  <div className="flex-1 bg-white rounded-lg py-1 px-3 text-xs text-slate-500 flex items-center justify-center gap-1.5 border border-slate-200 ">
                    <Lock className="w-3 h-3 flex-shrink-0" />{" "}
                    collabboard.com/public/product-roadmap
                  </div>
                    ...
                    {[
                      {
                        ...
                        items: ["Mobile app", "Performance improvements", "Analytics dashboard"],
                      },
                      {
                        label: "Next",
                        ...
                        items: ["AI assistant", "Integrations", "Custom views"],
                      },
                      {
                        label: "Later",
                        ...
                        items: ["Advanced permissions", "Team workload insights", "API v2"],
                      },
                    ].map((col, ci) => (
                      <div key={ci} className="space-y-2">
                        <div
                          className={`inline-block px-2.5 py-0.5 rounded-full text-xs font-bold ${col.labelColor}`}
                        >
                          {col.label}
                        </div>
                        {col.items.map((item, ii) => (
                          <div key={ii} className={`p-3 rounded-xl border shadow-sm ${col.cardBg}`}>
                            <p className="font-semibold text-xs text-slate-800 mb-2.5">{item}</p>
                            <div className="flex items-center gap-2">
                              <img
                                src={`/avatar/avatar${((ci * 3 + ii) % 8) + 1}.png`}
                                className="w-5 h-5 rounded-full flex-shrink-0"
                                alt=""
                              />
                              <div
                                className={`flex-1 h-1.5 ${col.barBg} rounded-full overflow-hidden`}
                              >
                                <div
                                  className={`h-full ${col.barColor} rounded-full`}
                                  style={{ width: `${[70, 45, 15][ii] || 0}%` }}
                                />
                              </div>
                            </div>
                          </div>
              ...
              <div className="mt-5 flex justify-center select-none pointer-events-none">
                <div className="flex flex-col items-center">
                  ...
                  <p className="font-hand text-base text-slate-600 rotate-2 text-center">
                    Transparent progress.
                    <br />
                    <span className="relative inline-block">
                      Stronger trust.
                      <ScribbleUnderline className="absolute -bottom-0.5 left-0 w-full h-2 text-teal-500" />
                    </span>
                  </p>
                </div>
              </div>
        ...
        <section className="py-16 sm:py-20 lg:py-28 px-4 sm:px-6 bg-white relative overflow-hidden">
          <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <FadeIn
              direction="left"
              className="relative hidden md:flex items-start justify-center order-2 lg:order-1"
            >
              <div className="relative w-full max-w-md">
                <div className="absolute -top-8 left-10 z-20 select-none pointer-events-none">
                  <p className="font-hand text-lg font-semibold text-slate-700 -rotate-2 leading-tight">
                    ...
                    <span className="relative inline-block">
                      as it happens.
                      <ScribbleUnderline className="absolute -bottom-1 left-0 w-full h-2 text-teal-400" />
                    </span>
                  </p>
                ...
                <Float delay={0.3} y={8} className="absolute -top-4 right-0 z-30">
                  <div className="bg-teal-50 border border-teal-200 p-3 rounded-xl shadow-lg rotate-3 w-40">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-1 text-[10px] text-teal-800">
                        <CheckCircle className="w-3 h-3 text-teal-500" /> Finalize copy
                      </div>
                      <div className="flex items-center gap-1 text-[10px] text-teal-800">
                        <CheckCircle className="w-3 h-3 text-teal-500" /> Design review
                      </div>
                      <div className="flex items-center gap-1 text-[10px] text-teal-800 opacity-60">
                        <div className="w-3 h-3 border border-teal-400 rounded" /> Ship it!{" "}
                ...
                <div className="bg-white rounded-[2rem] shadow-2xl border border-slate-200 p-6 mt-10">
                  <div className="flex items-center gap-3 border-b border-slate-100 pb-4 mb-4">
                    <div className="w-10 h-10 bg-blue-600 rounded-xl flex items-center justify-center text-white font-black text-base shadow-lg shadow-blue-600/30">
                      C
                    </div>
                    <h3 className="text-lg font-bold flex items-center gap-2 text-slate-900 ">
                      Activity <Activity className="w-4 h-4 text-blue-500" />
                    </h3>
                  </div>
                  <div className="flex gap-2.5 mb-4 text-sm font-medium overflow-x-auto pb-1">
                    {["All", "Notes", "Tasks", "Boards", "Users"].map((t, i) => (
                      <div
                        key={t}
                        className={`px-3 py-1 rounded-full whitespace-nowrap flex-shrink-0 ${i === 0 ? "bg-blue-600 text-white" : "text-slate-500"}`}
                      >
                        {t}
                      </div>
                    ))}
                    ...
                    {[
                      {
                        img: 9,
                        name: "Emma",
                        action: "completed the checklist",
                        detail: '"Design MVP" in "Product Launch"',
                      ...
                      },
                      {
                        ...
                        detail: '"API Integration" in "Product Launch"',
                        color: "",
                        ago: "15m ago",
                        dot: "bg-blue-500",
                      },
                      ...
                      <div key={i} className="flex gap-3 items-start">
                        <img
                          src={`/avatar/avatar${ev.img <= 8 ? ev.img : ((ev.img - 9) % 8) + 1}.png`}
                          className="w-8 h-8 rounded-full flex-shrink-0"
                          alt=""
                        />
                        <div className="flex-1 min-w-0">
                          <p className="text-xs text-slate-600 ">
                            <span className="font-bold text-slate-900 ">{ev.name}</span> {ev.action}
                          </p>
                          <p className="text-xs font-semibold text-slate-800 mt-0.5 truncate">
                            {ev.detail}{" "}
                            {ev.color && <Check className={`inline w-3 h-3 ${ev.color}`} />}
                          </p>
                        </div>
                ...
                <Float
                  delay={0.5}
                  y={8}
                  className="absolute -bottom-4 -right-28 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200/80 p-4 w-[260px] z-30"
                >
                  <div className="flex items-center gap-2.5 mb-3">
                    ...
                    <div>
                      <div className="font-bold text-sm flex items-center gap-1.5 text-slate-900 ">
                        CollabBoard{" "}
                        <span className="bg-slate-200 text-slate-600 text-[10px] px-1.5 py-0.5 rounded">
                          APP
                        </span>
                      </div>
                  ...
                  <div className="space-y-2.5">
                    {[
                      ...
                      <div key={i} className="flex gap-2 items-center">
                        <img
                          src={`/avatar/avatar${n.img <= 8 ? n.img : ((n.img - 9) % 8) + 1}.png`}
                  ...
                  <div className="mt-3 pt-3 border-t border-slate-100 text-center text-xs font-bold text-teal-600">
                    See all activity →
                  </div>
                </Float>

                <div className="absolute top-[30%] -right-8 z-40 select-none pointer-events-none text-center">
                  <p className="font-hand text-base font-semibold text-slate-700 -rotate-2 leading-tight max-w-[120px]">
                    Get notified
                    <br />
                    where{" "}
                    <span className="relative inline-block">
            ...
            <div className="relative z-20 order-1 lg:order-2">
              <FadeIn>
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-teal-200 rounded-full mb-5 shadow-sm text-teal-600 font-medium text-sm">
              ...
              <FadeIn delay={0.1}>
                <p className="text-base sm:text-lg text-slate-600 mb-8 max-w-md">
                  From note updates to task completions, CollabBoard keeps everyone aligned with
                  real-time activity and smart notifications.
                </p>
              </FadeIn>
              <FadeIn delay={0.2} className="space-y-6 max-w-md">
                {[
                  {
                    ...
                    desc: "See everything as it happens.",
                    color: "bg-teal-100 text-teal-600",
                    icon: Activity,
                  },
                  {
                    title: "Smart notifications",
                    desc: "Never miss what matters most.",
                    color: "bg-blue-100 text-blue-600",
                    icon: Bell,
                  },
                  {
                    title: "Slack integration",
                    desc: "Get updates where your team already talks.",
                    color: "bg-amber-100 text-amber-600",
                    icon: SlackIcon,
                  },
                  {
                    title: "Team transparency",
                    desc: "Build trust with full visibility.",
                    color: "bg-emerald-100 text-emerald-600",
                    icon: Users,
                  },
                ].map((item, i) => (
                  ...
                  {[
                    {
                      ...
                      node: <SlackIcon className="w-6 h-6" />,
                    },
                    ...
                    <div
                      key={i}
                      className={`w-10 h-10 ${t.bg} rounded-xl flex items-center justify-center shadow-sm`}
                    >
                      {t.node}
                    </div>
                  ))}
        ...
        {/* SECTION 5 — Final CTA */}
        <section
          className="py-16 sm:py-20 lg:py-28 px-4 sm:px-6 relative overflow-hidden"
          style={{ background: "linear-gradient(135deg,#f8fafc 0%,#ffffff 50%,#f0fdfa 100%)" }}
        >
          ...
          <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-10 lg:gap-16 items-center relative z-10">
            <div>
              ...
              <FadeIn delay={0.1}>
                <p className="text-base sm:text-lg text-slate-600 mb-8 max-w-md">
                  CollabBoard brings your team, tasks, and ideas into one shared space so you can
                  focus on what matters and ship more, together.
                </p>
              </FadeIn>
              ...
              <FadeIn
                delay={0.3}
                className="flex flex-wrap gap-3 sm:gap-5 mb-8 text-sm text-slate-500"
              >
                {[
              ...
              <FadeIn delay={0.4}>
                <div className="bg-white border border-slate-200 rounded-2xl p-5 max-w-sm shadow-sm mb-6">
                  <p className="text-slate-600 font-medium mb-4 text-sm italic">
                    &ldquo;CollabBoard is the glue that keeps our projects and people
                    aligned.&rdquo;
                  </p>
                  <div className="flex items-center gap-3">
                    <img src="/avatar/avatar7.png" className="w-9 h-9 rounded-full" alt="" />
                    <div>
                      <p className="font-bold text-sm text-slate-900 ">Arjun Mehta</p>
                      <p className="text-xs text-slate-500">CTO, Brightly</p>
                    </div>
                  </div>
                </div>
                <div className="select-none pointer-events-none">
                  <p className="font-hand text-xl text-slate-700 leading-tight">
                    More clarity. More velocity. More impact.
                    <br />
                    That&apos;s{" "}
            ...
            <FadeIn delay={0.2} direction="right" className="relative hidden md:block">
              <div className="absolute -top-6 left-[30%] z-20 select-none pointer-events-none text-center">
                <p className="font-hand text-lg font-semibold text-slate-700 -rotate-1 leading-tight">
                  Big ideas. Small steps.
                  <br />
                  <span className="relative inline-block">
                    Real progress.
                    <ScribbleUnderline className="absolute -bottom-0.5 left-0 w-full h-2 text-teal-400" />
                  </span>
                </p>
              </div>

              <div className="bg-white rounded-3xl shadow-2xl border border-slate-200 p-5 mt-8">
                <div className="grid grid-cols-4 gap-2.5">
                  {[
                    ...
                    <div key={col.label} className="space-y-2">
                      <div
                        className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-lg text-xs font-bold ${col.labelColor}`}
                      >
                      ...
                      {col.notes.map((note, ni) => (
                        <div key={ni} className={`${note.bg} p-3 rounded-xl shadow-sm`}>
                          <p className="font-semibold text-xs text-slate-800 mb-2">{note.title}</p>
                              ...
                              {note.checks.map((c, ci) => (
                                ...
                                >
                                  {ci < 2 ? (
                                    ...
                                    <div className="w-2.5 h-2.5 border border-slate-400 rounded flex-shrink-0" />
                                  )}
                                  {c}
                                </div>
                              ))}
                          ...
                          {"avatar" in note && note.avatar && (
                            <img
                              src={`/avatar/avatar${note.avatar <= 8 ? note.avatar : ((note.avatar - 9) % 8) + 1}.png`}
                              className="w-5 h-5 rounded-full mt-2 border-2 border-white"
                              alt=""
                            />
                          )}
                        </div>
              ...
              <div className="absolute -top-2 -right-2 select-none pointer-events-none z-10">
                <p className="font-hand text-base text-slate-600 -rotate-2 text-center max-w-[110px] leading-tight mb-1">
              ...
              <div className="absolute -bottom-3 left-[35%] z-20 select-none pointer-events-none -rotate-2">
                <div className="flex items-center gap-1.5 bg-white border border-slate-200 rounded-2xl px-3 py-2 shadow-lg text-sm font-bold text-slate-800 ">
            ...
            <div className="md:hidden grid grid-cols-2 gap-3">
              {[
                ...
                {
                  label: "In progress",
                  lc: "bg-amber-100 text-amber-700",
                  bg: "bg-amber-50 border border-amber-100",
                  title: "Build mobile app",
                },
                {
                ...
                <div key={c.label} className="space-y-2">
                  <div className={`inline-block px-2 py-0.5 rounded-lg text-xs font-bold ${c.lc}`}>
                    {c.label}
                  </div>
