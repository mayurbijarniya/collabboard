...
test.describe("Board Management", () => {
  ...
  test.describe("Board Not Found", () => {
    test("should display not found page for invalid board ID", async ({ authenticatedPage }) => {
      ...
      // Should show the "Go to collabboard" button
      const homeButton = authenticatedPage.getByRole("link", { name: "Go to collabboard" });
    ...
    test("should show not found page for invalid public board", async ({ page }) => {
      ...
      // Click the "Go to collabboard" button
      const homeButton = page.getByRole("link", { name: "Go to collabboard" });
