  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        disabled={readonly}
        className={cn(
          "flex-1 border-none bg-transparent px-1 py-1 text-sm resize-none overflow-hidden outline-none",
      ...
      {showDeleteButton && !readonly && (
        <Button
          variant="ghost"
          size="icon"
          className="h-6 w-6 opacity-50 md:opacity-0 md:group-hover/item:opacity-50 md:hover:opacity-100 text-muted-foreground hover:text-destructive"
          onMouseDown={() => {
